...
<body>
    ...
    <div class="iconn-barr">
        <a href='#' class='facebook ' target='_blank' style="background: #3b5998; text-decoration: none; color: white;">
        ...
        <a href='' class='whatsapp ' target='_blank' style="background:#13e748; text-decoration: none; color: white;">
