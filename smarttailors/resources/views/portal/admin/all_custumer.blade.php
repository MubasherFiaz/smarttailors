    ...
    @foreach($custumers as $custumer)
                          ...
                          <tr>
                               <td class="user">  <?php
                                ...
                                ?>
                                <img src="{{asset('public/images/')}}/{{$custumer->img}}"  class="avatar" >
                              <?php  }
                                ?>
                                ...
                                <td>{{$custumer->email}}</td>
                                 ...
                                 <td>{{$custumer->city}}</td>
                               <td>
                               @if($custumer->status==0)
                               Inactive
                               @else
                               Active
                               @endif
                                  </td>
                               <td> {{$custumer->rating}}  </td>
                                 
                   <td> {{$custumer->created_at}}</td>
                   <td>
<!-- <a href="{{url('/update-measurement-part/').'/'.$custumer->id}}" type="button" class="btn btn-info btn-xs" >View </a>  -->
